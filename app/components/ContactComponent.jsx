  ...
  return (
    ...
    <div className="rounded-[20] flex justify-center h-125 w-125" style={{ background: "var(--slides)" }}>
        <div className="flex flex-col gap-6 items-center justify-center text-center">
            ...
            <li className="pb-10 hover:text-gray-400">
            <Link className="flex items-center gap-2" href="mailto:jspencer0709@gmail.com">
            {theme === "dark" ? (
                <img className="w-10 filter invert brightness-e" src="/tbGmailLogo.webp" />
            ) : (
                <img className="w-10" src="/tbGmailLogo.webp" />
            )}
              Mail
            </Link>
            </li>
            ...
            {theme === "dark" ? (
                <img className="w-10 filter invert brightness-e" src="/tbArtStationLogo.webp" />
            ) : (
                <img className="w-10" src="/tbArtStationLogo.webp" />
            )}
              ArtStation
            </div>
            </li>
